...
import { DappPDA } from "../setups/hello_world_setup";
import { HelloWorld } from "../../target/types/hello_world";
const mockDappProgram: anchor.Program<HelloWorld> =
anchor.workspace.HelloWorld;

import { ConnectionPDA } from "../setups/connection_setup";
...
export class XcallPDA {
  ...
  static config() {
    let [pda, bump] = PublicKey.findProgramAddressSync(
      [Buffer.from("config")], xcallProgram.programId
